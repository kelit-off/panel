...
const Select = styled.select<Props>`
    ${tw`shadow-none block px-3.5 py-2.5 pr-8 rounded-lg border w-full text-sm transition-colors duration-150 ease-linear`};
    ...
    ${props => !props.hideDropdownArrow && css`
        ${tw`bg-neutral-900 border-neutral-700 text-neutral-100 hover:border-neutral-600`};
